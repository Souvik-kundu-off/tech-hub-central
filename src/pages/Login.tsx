      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-[280px] mx-auto text-sm">
            Sign in with your Google account to access your profile and projects.
          </p>
        </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-sm">
          <Button 
            variant="outline" 
            className="w-full h-12 text-[15px] font-medium border-border hover:bg-accent flex items-center justify-center gap-3 active:scale-[0.98] transition-all"
          ...
          <div className="mt-6 flex items-center justify-between text-[11px] text-muted-foreground">
            <Link to="/about" className="hover:text-foreground">Need help?</Link>
            <span>v1.0.0</span>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-muted-foreground">
            ...
            <Link to="/signup" className="text-primary font-medium hover:underline inline-flex items-center gap-1 group">
              Join us <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform" />
            </Link>
          </p>
        </div>
      </div>
